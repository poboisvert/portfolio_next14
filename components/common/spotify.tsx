...
const SpotifyModal = () => {
  ...
  return (
    <>
      <button
        onClick={toggleModal}
        className='fixed bottom-4 right-4 p-2 text-white rounded-full shadow-lg transition'
      >
        <svg height='48' width='48' viewBox='0 0 496 496' fill='currentColor'>
          <path
            style={{ fill: "#37D660" }}
      ...
      {isOpen && (
        <div
          ref={modalRef}
          className='fixed bottom-0 right-0 m-4 shadow-lg overflow-hidden'
        >
          <iframe
            src='https://open.spotify.com/embed/playlist/37i9dQZEVXbLiRSasKsNU9?utm_source=oembed'
            width='300'
            height='380'
            frameBorder='0'
